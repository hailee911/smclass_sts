...
public class MemberServiceImpl implements MemberService {
	...
	public void save(MemberDto mdto) {
		memberRepository.save(mdto); //자동으로 저장 - mapper.xml 필요없어짐.
	...
	public MemberDto findById(String id) {
		...
		MemberDto memberDto = memberRepository.findById(id).orElseThrow( ()->{return new IllegalArgumentException("데이터 처리시 에러!!");} );
		return memberDto;
	}
