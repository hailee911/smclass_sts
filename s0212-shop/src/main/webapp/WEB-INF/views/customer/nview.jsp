					...
					<div class="viewDivMt">
						<div class="viewHead">
							...
							<div class="day">
								...
								<fmt:formatDate value="${bdto.bdate }" pattern="yy-MM-dd"/>
								</span></p>
							</div>
						</div>
						...
						<table summary="이전다음글을 선택하여 보실 수 있습니다." class="preNext" border="1" cellspacing="0">
							...
							<tbody>
								<tr>
									...
									<td>
									<c:if test="${pdto != null}">
									<a href="/customer/nview?bno=${pdto.bno }">${pdto.btitle }</a>
									</c:if>
								...
								<tr>
									...
									<td>
									<c:if test="${ndto != null}">
									<a href="/customer/nview?bno=${ndto.bno }">${ndto.btitle }</a>
									</c:if>
									<c:if test="${ndto == null}">이전글이 없습니다.</c:if>
									</td>
								</tr>
							</tbody>
						</table>
