			...
			<div id="contents">
				<div id="customer">
							...
							<tbody>
							  ...
							  <c:if test=" ${day eq today }">
								<tr>
									...
									<td>
									<fmt:formatDate value="${ct.bdate}" pattern="yyyy-MM-dd" />
									</td>
					...
					<div class="btnAreaList">
						...
						<c:if test="${page != 1 }">
						  <a href="/customer/notice?page=1" class="n"><img src="../images/btn/btn_pre2.gif" alt="처음으로" /></a>
						</c:if>
					    ...
					    <c:if test="${page != maxpage }">
                          <a href="/customer/notice?page=${endpage}" class="n"><img src="../images/btn/btn_next1.gif" alt="뒤페이지로"/></a>
                        </c:if>
